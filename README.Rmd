...
We next compare the predicted log odds ratio to the reported effect size. This step is applicable to summary data that has been derived from a logistic regression model of case-control status. Since the function to derive the predicted log odds ratio can be a bit slow, we restrict the glioma example to just the first 20 SNPs. 
