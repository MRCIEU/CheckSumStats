...
The plot shows a strong positive correlation between the expected and reported effect sizes, an intercept close to zero and a slope that is close to 1. This is reasonably close to what we'd expect to see in the absence of major analytical issues or errors in the summary data. Examples [3] (#example_3) [4] (#example_4) and [5] (#example_5) illustrate scenarios where reported and expected effect sizes differ quite substantially. 
...
```
!["example2_gcplot.png"](/man/figures/README-example2_gcplot.png)
