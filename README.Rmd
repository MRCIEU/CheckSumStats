...
```{r make_plot_predlnor1,eval = TRUE}
Dat1<-Dat[1:5,]
...
We can also plot the bias, i.e. the deviation of the predicted log odds ratio from the reported effect size, which we calculate as (predicted-reported)/reported$\times$100
