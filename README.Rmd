...
We next check that the reported effect allele metadata is correct, by comparing the reported effect alleles for glioma to the GWAS catalog. We do this using the make_plot_gwas_catalog() function. A dataframe of results, including the comparisons to the GWAS catalog, can also be obtained using the compare_effect_to_gwascatalog function().  
