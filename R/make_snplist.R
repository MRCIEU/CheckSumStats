...
# 	# gwas_variants<-gwasrapidd::get_variants(reported_trait="Metabolite levels (small molecules and protein measures)")
# 	# gwas_variants@variants$variant_id
# 	# 	
# 	# "rs1260326" %in% gwas_variants@variants$variant_id 
